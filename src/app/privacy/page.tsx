...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-black">
      ...
      <main className="pt-20 pb-8 px-6 md:px-12">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 md:p-12">
            ...
            <p className="text-gray-400 mb-6">Last updated: August 14, 2025</p>
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <ul className="list-disc list-inside space-y-2 mb-6 text-gray-300">
                ...
                <li>
                  ...
                  Agreement) refers to Gradguru, Flat 39, Lohmann House, SE11
                  5BU, London.
                </li>
                <li>
                ...
                <li>
                  ...
                  Gradguru, accessible from{" "}
                  <a
                    href="hirevue.gradgurucoaching.com"
                    rel="external nofollow noopener"
                    target="_blank"
                    className="text-green-400 hover:text-green-300 underline"
                  >
                    hirevue.gradgurucoaching.com
                  </a>
                </li>
                <li>
              ...
              <ul className="list-disc list-inside space-y-4 mb-6 text-gray-300">
                <li>
                  <strong className="text-white">
