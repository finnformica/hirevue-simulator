    ...
    <section className="w-full bg-black py-20 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex flex-col items-center text-center mb-8">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-brand/30 bg-brand/10 text-brand text-sm mb-6">
            <span>Ace your HireVue interviews</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
            Practice Makes Perfect
            <br />
            <span className="text-brand">Graduate Interviews</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <a
              href="#start"
              className="bg-brand hover:bg-brand/90 text-brand-foreground font-medium px-6 py-3 rounded-md transition-colors flex items-center justify-center"
            >
